;; yasnippet
;;
;; see : https://github.com/rmies/yasnippet-haskell/
;;
  ...
  (defun hsnips (the-mode)
    (yas/define-snippets
     ...
     '(
       ...
       ;; scheme: "imp", then one letter for the initial letter of each
       ;; dot-separated part
       
       ;; currently uses the ya/snippets disambiguation popup for
       ;; ambiguities (should it?); this is specified by a dot in the macro
       ;; string (you only need to type "impdm", not "impdm.Map" -- the
       ;; part after the dot is the name of the menu item)
